...
//Esc, Alt, GUIの位置
   ...
   * |------+------+------+------+------+------+------+------+------+------+------+------+------+------|
   * |Adjust| Esc  | Alt  | GUI  | CMD  |LOWER |Space |Enter |RAISE | Bspc | Left | Down |  Up  | Right|
   * `-------------------------------------------------------------------------------------------------'
   */
  [_QWERTY] = LAYOUT( \
      ...
      ADJUST,  KC_ESC,  KC_LALT, KC_LGUI, CMDESC,  LOWER,   KC_SPC,  KC_ENT,  RAISE,   ALTBSPC, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT \
      ),
  ...
  [_RAISE] = LAYOUT( \
      KC_F1  , KC_F2  , KC_F3  , KC_F4  , KC_F5  , KC_F6  ,                   KC_F7  , KC_F8  , KC_F9,   KC_F10,  KC_F11,  KC_F12 , \
      KC_TILD, KC_EXLM, KC_AT  , KC_HASH, KC_DLR , KC_PERC,                   KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN, KC_RBRC, \
      KC_LCTL, KC_LBRC, KC_RBRC, KC_GRV , KC_MINS, KC_EQL ,                   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_BSLS, KC_ENT , \
      KC_LSFT, KC_LCBR, KC_RCBR, KC_TILD, KC_UNDS, KC_PLUS, _______, _______, _______, _______, _______, _______, KC_PIPE, _______, \
      _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______  \
      ),
